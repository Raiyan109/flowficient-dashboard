...
const Bookings = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      calendarDays.push(
        <div
          ...
          className={`w-6 h-6 flex items-center justify-center rounded-md text-[10.7px]  font-canvasans cursor-pointer ${
            isSelected ? "bg-black text-white" : "text-[#3c3c3c]"
          }`}
        >
          {day}
        </div>
  ...
  const getStartOfWeek = (date) => {
    ...
    const diff =
      day >= 2 ? date.getDate() - (day - 2) : date.getDate() - (day + 5); // Adjust to start from Tuesday
    ...
    <div className="flex h-screen">
      ...
      <div className="w-1/4 space-y-[10px]">
        <div className="w-[270.8px] h-[265.7px] rounded-[25px] bg-[#f1f1f1] p-4">
          ...
          <div className="grid grid-cols-7 gap-1">
            {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
              <div
                key={day}
                className="text-center text-[7.4px] font-canvasans"
              >
                {day}
              </div>
            ))}
        ...
        <div className="w-[270.8px] h-[190.9px] rounded-[25px] bg-[#f1f1f1]">
          <h1 className="text-[13px] pt-[29px] pl-[16px] font-canvasans font-bold pb-[23px]">
            Calendar
          </h1>
          <div className="flex flex-col pl-[16px] gap-[15px]">
            ...
            <label className="flex items-center space-x-2">
              ...
              />
              <span className="text-[#3f3f3f] font-canvasans text-[10.7px]">
                Dr. A Parkar
              </span>
            </label>
        ...
        <div
          className="w-[270.8px] h-[168.9px] rounded-[25px]"
          style={{
        ...
        >
          <div className="flex items-center pt-[17px] pl-[19px] gap-[6px]">
            ...
            <h1 className="font-canvasans text-[9px] text-white">
              Quick Actions
            </h1>
          </div>
        ...
        <div className="w-[866.8px] h-[645.9px] rounded-[25px] bg-[#f1f1f1]">
          ...
          <div className="flex justify-between pt-[23px] px-[29px]">
            <div className="flex items-center gap-[13px]">
              <h1 className="text-[20px] font-canvasans font-bold">
                {currentDate.toLocaleString("default", {
                  month: "long",
                  year: "numeric",
                })}
            ...
            <div className="flex items-center h-[28.6px] font-gordita gap-[15px]">
              <div className="flex items-center">
                <button
                  ...
                  className={`text-[6.1px] px-[10px] py-[10px] rounded-md w-[87.7px] h-[28px] ${
                    selectedView === "Day"
                      ? "bg-black text-white"
                      : "bg-white text-black"
                  }`}
              ...
              <button
                className="w-[106.6px] h-[28.6px] bg-black text-white rounded-[5px] flex gap-1 items-center justify-center"
                onClick={toggleSetAppointmentsModal}
              >
          ...
          <div className="pt-[63px] pl-[48px] flex items-center gap-[9px]">
            {generateWeekDates(selectedDate || currentDate).map(
              (date, index) => {
                const isSelected =
                  selectedDate &&
                ...
                return (
                  <div
                    key={index}
                    className={`w-[107.4px] h-[74.2px] rounded-[15px] flex flex-col items-center justify-center -space-y-2 ${
                      isSelected
                  ...
                  >
                    <h1
                      className={`text-[10.6px] font-montserrat ${
                    ...
                    <h1
                      className={`text-[19px] font-canvasans font-bold ${
            ...
            <div className="w-[866.8px] h-[440.1px] rounded-[25px] bg-white mt-[13px]">
              <div className="pt-[55px] relative">
                ...
                <div className="bg-[#8c52ff] rounded-[10px] w-[107.4px] h-[72.5px] absolute top-16 left-7">
                  <h1 className="text-white text-[5.6px] font-montserrat pt-[7px] pl-[9px]">
                    Naeem Hashim
                  </h1>
                  ...
                  <h1 className="text-[3.6px] text-white absolute bottom-[19px] pl-[9px]">
                    8 am - 9 am <span className="font-bold">Pinelands</span>
                  </h1>
                </div>
              </div>
