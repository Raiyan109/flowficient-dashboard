        ...
        <div className="flex items-center justify-center h-screen">
            <div className="flex items-start justify-center gap-96">
                <div className="flex-1 flex flex-col items-center justify-center">
                    <div className="bg-white border border-formBorder rounded-xl pt-5 pb-14 px-7">
                        {/* Logo */}


                        <div className="space-y-2">
                            <h1 className="font-canvasans font-bold text-lg">Get Started</h1>
                            <h4 className="font-canvasans font-thin text-[#515151] text-lg">Welcome to Flowficient AI - Let’s get started</h4>
                        </div>
                ...
                <div className="flex-1 relative pt-20">
                    ...
                    <h1 className="text-6xl font-montserrat italic float-end absolute top-48 left-44">Autopilot</h1>
                </div>
            </div>
        </div>
    )
