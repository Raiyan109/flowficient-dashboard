                ...
                <div className="bg-white border border-formBorder rounded-2xl pt-5 pb-14 px-7">
                    <div className="space-y-2">
                        <div className="flex items-center justify-between w-full">
                            <h1 className="font-canvasans font-bold text-lg">Onboarding Form</h1>
                            <h1 className="text-xs font-bold">1/2</h1>
                        </div>
                        <h4 className="font-canvasans font-extralight text-[#515151] text-md">Please provide us with the following details</h4>
                    </div>
