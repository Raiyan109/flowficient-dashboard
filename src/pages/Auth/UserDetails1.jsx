      ...
      <div className="flex flex-col items-center justify-center">
        <div className="bg-white border border-formBorder rounded-2xl pt-5 pb-14 px-7">
          <div className="space-y-2">
            ...
            <h4 className="font-canvasans font-extralight text-[#515151] text-md">
          ...
          <form className="pt-8 space-y-6 pb-3">
            <div className="flex flex-col space-y-3">
              <h1 className="text-sm font-canvasans">
                Is this account for a practice or an individual professional?
              </h1>
              <div className="flex space-x-6">
                ...
                <label className="flex items-center space-x-2">
                  ...
                  />
                  <span className="text-gray-700 font-canvasans text-sm">
                    Practice
                  </span>
                </label>
            ...
            <div className="flex flex-col space-y-1">
              <label className="font-canvasans text-xs font-extralight">
                Practice Name
              </label>
              <input
                type="text"
            ...
            <div className="flex flex-col space-y-3">
              <h1 className="text-sm font-canvasans">
                Is this account for more than one location?
              </h1>
              <div className="flex space-x-6">
                {/* Practice Checkbox */}
                <label className="flex items-center space-x-2">
            ...
            <div className="flex flex-col space-y-2">
              <label className="font-canvasans text-xs font-extralight">
                Select the number of your locations
              </label>
              <select
          ...
          <div className="flex flex-col items-center justify-center text-sm">
            <h1 className="text-[#515151] text-center font-canvasans">
              By signing up you agree to the{" "}
              <Link to="/auth/sign-up" className="text-[#8c52ff] font-bold">
                Terms and Conditions.
              </Link>
            </h1>
            <Link
              to="/auth/sign-up"
              className="text-[#8c52ff] font-bold text-center"
            >
              Privacy Policy
            </Link>
          </div>
